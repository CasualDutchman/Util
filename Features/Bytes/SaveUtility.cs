...
{
    public static void Save(ISaveItem saveItem, string folderName, string fileName, bool overwrite = true)
	{
	...
	public static bool Load<T>(ref T item, string folderName, string fileName) where T: ISaveItem, new()
	{
		string prefix = Application.persistentDataPath + "/";
		string folderPath = prefix + folderName;
		string filePath = folderPath + "/" + fileName;
