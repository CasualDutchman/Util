...
public class ByteUtility
{
	...
	public class Writer
	{
		...
		public unsafe void Add<T>(T _item, int _index = -1) where T: ISaveItem
		{
			if (_item == null)
				return;
		...
		public unsafe void Add<T>(T[] _array, int _index = -1) where T : ISaveItem
		{
	...
	public class Reader
	{
		...
		public unsafe T ReadItem<T>(int index, out int byteSize) where T: ISaveItem, new()
		{
			byteSize = 0;
		...
		public unsafe T ReadNextItem<T>() where T : ISaveItem, new()
		{
		...
		public unsafe T[] ReadArray<T>(int index, out int byteSize) where T : ISaveItem, new()
		{
			byteSize = 0;
		...
		public unsafe T[] ReadNextArray<T>() where T : ISaveItem, new()
		{
